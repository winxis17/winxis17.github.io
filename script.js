      ...
      Swal.fire("Awas aja kalau kamu bohong", "", "error").then(function () {
        ...
        const {
          ...
          const pertanyaan = Swal.fire({
            title: `${Habib} sayang ga sama ${Viola}?`,
            showDenyButton: true,
            ...
            if (result.isConfirmed) {
              Swal.fire(`${Viola} juga sayang banget sama ${Habib}`).then(function () {
                Swal.fire({
                  ...
                  val = e.value
                  Swal.fire(`Makasih ya udah sayang sama ${Viola} ${val}%`).then(function () {
                    Swal.fire({
                      title: `Sekarang ${Habib} kangen ga sama ${Viola}?`,
                      showDenyButton: true,
                      showCancelButton: false,
                      ...
                      /* Read more about isConfirmed, isDenied below */
                      if (result.isConfirmed) {
                        Swal.fire(`Huhu iya ${Viola} juga kangen ${Habib} , makasihhh yaa`).then(function () {
              ...
              Swal.fire(`Yakin ga suka sama ${Viola}?`, '', 'error').then(function () {
